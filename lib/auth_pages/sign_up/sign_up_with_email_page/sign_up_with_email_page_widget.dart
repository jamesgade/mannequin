...
import 'sign_up_with_email_page_model.dart';
export 'sign_up_with_email_page_model.dart';
...
class _SignUpWithEmailPageWidgetState extends State<SignUpWithEmailPageWidget> {
  late SignUpWithEmailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignUpWithEmailPageModel());
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.goNamed('SignInOptionsPage');
                                        },
                                        child: Text(
                                          'Sign In',
                                          style: FlutterFlowTheme.of(context)
