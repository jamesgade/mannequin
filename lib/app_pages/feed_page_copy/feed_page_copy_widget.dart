...
import 'feed_page_copy_model.dart';
export 'feed_page_copy_model.dart';

class FeedPageCopyWidget extends StatefulWidget {
  const FeedPageCopyWidget({Key? key}) : super(key: key);

  @override
  _FeedPageCopyWidgetState createState() => _FeedPageCopyWidgetState();
}

class _FeedPageCopyWidgetState extends State<FeedPageCopyWidget> {
  late FeedPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeedPageCopyModel());
  }
                                                            ...
                                                            child: Material(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Stack(
                                                                  children: [
                                                                    if (functions.listContainsItem(
                                                                            gridViewProductsRecord.favouritedUsers.toList(),
                                                                            currentUserUid) ==
                                                                        false)
                                                                      Padding(
                                                                        padding: EdgeInsetsDirectional.fromSTEB(
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          Icons
                                                                              .favorite_sharp,
                                                                          color:
                                                                              FlutterFlowTheme.of(context).favourite,
                                                                          size:
                                                                              22.0,
                                                                        ),
                                                                      ),
