...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/signInWithEmailPage',
          builder: (context, params) => SignInWithEmailPageWidget(),
        ),
        FFRoute(
          name: 'FeedPage',
          path: '/feedPage',
        ...
        FFRoute(
          ...
          path: '/addProductPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AddProductPage')
              : AddProductPageWidget(),
        ),
        FFRoute(
          name: 'SignUpWithEmailPage',
          path: '/signUpWithEmailPage',
          builder: (context, params) => SignUpWithEmailPageWidget(),
        ),
        FFRoute(
          name: 'WelcomePage',
          path: '/welcomePage',
        ...
        FFRoute(
          name: 'ComingSoonPage',
          path: '/comingSoonPage',
          builder: (context, params) => ComingSoonPageWidget(),
        ),
        FFRoute(
          name: 'ContinueWithPhonePage',
          path: '/continueWithPhonePage',
          builder: (context, params) => ContinueWithPhonePageWidget(),
        ),
        FFRoute(
